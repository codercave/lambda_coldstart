...
This is a sample template for lambda_coldstart - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name lambda_coldstart --tail
```
...
```bash
aws cloudformation delete-stack --stack-name lambda_coldstart
```
